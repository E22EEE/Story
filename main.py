...
EMOJIS = list("😭🤣😂😅😆😁😄😃😀🥳🤩🤩😍🥰😘😚😙😗😉🤪😜😝😛😋🥲🙂🙃😶😐😑🫣🤭")
@rickthon.on_message(filters.regex("^الاسرع$") & filters.group)
@rickthon.on_edited_message(filters.regex("^الاسرع$") & filters.group)
...
@rickthon.on_message(filters.regex("^مشاهير$") & filters.group)
@rickthon.on_edited_message(filters.regex("^مشاهير$") & filters.group)
...
@rickthon.on_message(filters.regex("^معاني$") & filters.group)
@rickthon.on_edited_message(filters.regex("^معاني$") & filters.group)
...
@rickthon.on_message(filters.regex("^اعلام دول$") & filters.group)
@rickthon.on_edited_message(filters.regex("^اعلام دول$") & filters.group)
